...
def register_webcast_conference_invitee(invitee, conference_id):
    """
...
def deregister_webcast_conference_invitee(invitee, conference_id=None):
    """
